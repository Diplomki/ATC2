                    ...
                    <form method="POST">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT parent.child_id as child_id, CONCAT(user.lastname,' ', user.firstname, ' ', user.patronymic) AS fio, subject.name as subject, grade_accept.grade as grade, 
                                ...
                                WHERE parent.user_id = {$_SESSION['id']} and grade_accept.grade is not null and branch.id = {$_SESSION['branch']}";
